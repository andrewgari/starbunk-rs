...
4. **Push**: Push the current branch to the remote repository (`git push origin <branch_name>`).
5. **Create PR**: Create the pull request on GitHub. You can use the GitHub MCP `create_pull_request` tool or run `gh pr create --title "..." --body "..."`.
6. **Report**: Provide the PR link to the user and mark the task as complete.
