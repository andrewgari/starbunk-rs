#!/bin/bash
cat << 'INNER' > crates/starbunk/src/llm/client/google.rs.patch
--- crates/starbunk/src/llm/client/google.rs
+++ crates/starbunk/src/llm/client/google.rs
@@ -160,5 +160,49 @@
...
+}
INNER
patch crates/starbunk/src/llm/client/google.rs < crates/starbunk/src/llm/client/google.rs.patch
